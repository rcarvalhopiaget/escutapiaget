...
function getBaseEmailHtml(content: string): string {
  return `
    ...
    <head>
      ...
      <title>Colégio Piaget - Sistema de Chamados</title>
      <style type="text/css">
              ...
              <table width="100%">
                <tr>
                  <td style="text-align: center; padding: 20px 0; background-color: #1e293b; border-radius: 8px 8px 0 0;">
                    <h1 style="margin: 0; color: #ffffff; font-size: 24px;">Colégio Piaget</h1>
        ...
        <table class="footer">
          <tr>
            <td style="padding: 15px;">
              ...
              <p>Se precisar de assistência, acesse o <a href="${process.env.NEXT_PUBLIC_APP_URL || 'https://escuta.escolapiaget.com.br'}" style="color: #3b82f6; text-decoration: none;">Portal Escuta Piaget</a>.</p>
            </td>
          </tr>
        </table>
      </div>
  ...
  try {
    ...
    const userEmailContent = `
      ...
      <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #e2e8f0;">
        ...
        <p style="margin: 0; font-weight: bold; font-size: 16px;">Equipe Colégio Piaget</p>
      </div>
    `;
...
Equipe Colégio Piaget
    ...
    const adminEmailContent = `
      ...
      <div style="margin-bottom: 25px;">
        <a href="${process.env.NEXT_PUBLIC_APP_URL || 'https://escuta.escolapiaget.com.br'}/admin/chamados" style="display: inline-block; padding: 12px 24px; background-color: #1e40af; color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: bold; text-align: center;">Acessar Painel Administrativo</a>
      </div>
...
${process.env.NEXT_PUBLIC_APP_URL || 'https://escuta.escolapiaget.com.br'}/admin/chamados
    `;
